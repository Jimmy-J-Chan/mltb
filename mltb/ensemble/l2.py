...
def L2_ensemble(oofs, y, ypreds, mdl_params):
    """
    Linear Model trained with L2 prior as regularizer (Ridge)
    *** ONLY FOR REGRESSION PROBLEMS ***
    """
    Xtest = ypreds
    cv_generator = StratifiedKFold(n_splits=5)
    mdl = Ridge(positive=True, fit_intercept=False, **mdl_params)
...
if __name__ == '__main__':
    ...
    ypreds = preds['ypreds']
    mdl_params = {}
    ypreds_ens, w = L2_ensemble(oofs, ytrain, ypreds, mdl_params)
    pass